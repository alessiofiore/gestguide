...
<body>
	...
	<h1><spring:message code="header.addinstructor"/></h1>
	...
	<form:form action="${url}" method="post">
		...
		<tr>
			...
			<td><form:input path="dateOfBirth" maxlength="10" size="10" id="datebirth"/></td>
		</tr>
		<tr>
			<td><label><spring:message code="label.hiringdate"/>:</label></td>
			<td><form:input path="hiringDate" maxlength="10" size="10" id="hiringdate"/></td>
		</tr>
		<tr>
