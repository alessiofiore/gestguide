	...
	<script>
		$(document).ready(
			...
			$(function() {
			    ...
			    $( "#datebirth" ).datepicker({"dateFormat": "dd/mm/yy"});
			    $( "#hiringdate" ).datepicker({"dateFormat": "dd/mm/yy"});
		  	});
	</script>
</head>
			...
			<div class="container">
				...
				<div class="crumbs">
					<ul id="breadcrumbs" class="breadcrumb">
						...
						<li>
							<a href='<c:url value="${pageContext.request.contextPath}/customer" />'><spring:message code="header.instructors" /></a>
						</li>
						<li class="current"><spring:message code="header.addinstructor" /></li>
					</ul>
				</div>
				<!-- /Breadcrumbs line -->
				...
				<div class="page-header">
					<div class="page-title">
						<h3>
							<spring:message code="header.addinstructor" />
						</h3>
					</div>
				</div>
				<!-- /Page Header -->
				...
				<div class="row">
					<div class="col-md-12">
						<c:url var="url" value="/instructor/add" />
						<form:form action="${url}" method="post" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-md-10">
									<form:input path="city" type="text" name="regular" class="form-control input-width-large" maxlength="50" size="20" />
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-md-10">
									<form:input path="dateOfBirth" type="text" name="regular" class="form-control input-width-small" maxlength="10" size="10" id="datebirth" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-2 control-label"><spring:message code="label.hiringdate" />:</label>
								<div class="col-md-10">
									<form:input path="hiringDate" type="text" name="regular" class="form-control input-width-small" maxlength="10" size="10" id="hiringdate" />
								</div>
							</div>
							<div class="form-group">
