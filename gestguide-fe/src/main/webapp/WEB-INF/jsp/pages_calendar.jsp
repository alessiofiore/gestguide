...
<head>
	...
	<title>Calendar | Melon - Flat &amp; Responsive Admin Template</title>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/assets/js/demo/pages_calendar.js"></script>
</head>
