			...
			<div class="container">
				...
				<div class="crumbs">
					<ul id="breadcrumbs" class="breadcrumb">
						...
						<li class="current">
							<spring:message code="header.vehicles"/>
						</li>
					</ul>

					<ul class="crumb-buttons">
						<li><a href="<c:url value="/vehicle/add" />" title=""><i class="icon-plus"></i><span><spring:message code="action.add"/></span></a></li>
					</ul>
				</div>
				<!-- /Breadcrumbs line -->
				...
				<div class="page-header">
					<div class="page-title">
						<h3><spring:message code="header.vehicles"/></h3>
					</div>
				</div>
				<!-- /Page Header -->
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i> <spring:message code="header.vehicles"/></h4>
