...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/plugins/respond/respond.min.js"></script>
	...
	$(document)
			.ready(
					function() {
						...
						$("#top-nav-menu")
								.load(
										"${pageContext.request.contextPath}/nav-topbar");
						$("#nav")
								.load(
										"${pageContext.request.contextPath}/nav-sidebar");
					});
			...
			<div class="container">
				...
				<div class="crumbs">
					<ul id="breadcrumbs" class="breadcrumb">
						...
						<li>
							<a href='<c:url value="${pageContext.request.contextPath}/customer" />'><spring:message code="header.vehicles" /></a>
						</li>
						<li class="current"><spring:message code="header.addvehicle" /></li>
					</ul>
				</div>
				<!-- /Breadcrumbs line -->
				...
				<div class="page-header">
					<div class="page-title">
						<h3>
							<spring:message code="header.addvehicle" />
						</h3>
					</div>
				</div>
				<!-- /Page Header -->
					...
					<div class="col-md-12">
						...
						<form:form action="${url}" method="post"
							...
							<div class="form-group">
								<label class="col-md-2 control-label"><spring:message code="label.brand" />:</label>
								<div class="col-md-10">
									<form:input path="marca" type="text" name="regular" class="form-control input-width-large" maxlength="30" size="20" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-2 control-label"><spring:message code="label.model" />:</label>
								<div class="col-md-10">
									<form:input path="modello" type="text" name="regular" class="form-control input-width-large" maxlength="16" size="16" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-2 control-label"><spring:message code="label.carlicense" />:</label>
								<div class="col-md-10">
									<form:input path="targa" type="text" name="regular" class="form-control input-width-small" maxlength="10" size="10" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-2 control-label"><spring:message code="label.fuel" />:</label>
								<div class="col-md-10">
									<form:select path="alimentazione"class="form-control input-width-large">
										<!-- Set var for option labels -->
										<spring:message code="input.select.fuel" var="fuel"/>
										<spring:message code="input.select.fuel.gasoline" var="gasoline"/>
										<spring:message code="input.select.fuel.diesel" var="diesel"/>
										<spring:message code="input.select.fuel.gpl" var="gpl"/>
										<spring:message code="input.select.fuel.methane" var="methane"/>
										
										<form:option value="-1" label="${fuel}" selected="true"/>
										<form:option value="0" label="${gasoline}"/>
										<form:option value="1" label="${diesel}"/>
										<form:option value="2" label="${gpl}"/>
										<form:option value="3" label="${methane}"/>

									</form:select>
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-2 control-label"><spring:message code="label.enginesize" />:</label>
								<div class="col-md-10">
									<form:input path="cilindrata" type="text" name="regular" class="form-control input-width-mini" maxlength="5" size="5" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-2 control-label"><spring:message code="label.enginepower" />:</label>
								<div class="col-md-10">
									<form:input path="cavalli" type="text" name="regular" class="form-control input-width-mini" maxlength="5" size="5" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-2 control-label"><spring:message code="label.trailer" />:</label>
								<div class="col-md-10">
									<label class="radio-inline"> 
										<form:radiobutton path="rimorchio" class="uniform" name="optionsRadios2" value="0" /> 
										<spring:message code="label.trailer.with" />
									</label> 
									<label class="radio-inline"> 
										<form:radiobutton path="rimorchio" class="uniform" name="optionsRadios2" value="1" /> 
										<spring:message code="label.trailer.without" />
									</label>
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-2 control-label"><spring:message code="label.vehiclestate" />:</label>
								<div class="col-md-10">
									<form:input path="stato" type="text" name="regular" class="form-control input-width-small" maxlength="2" size="2" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-2 control-label"><spring:message code="label.timechange" />:</label>
								<div class="col-md-10">
									<form:input path="tempoCambio" type="text" name="regular" class="form-control input-width-small" maxlength="4" size="4" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-2 control-label"><spring:message
										code="label.school" />:</label>
								<div class="col-md-10">
